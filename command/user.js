...
const FLY_RC_LOCAL_DATA_PATH = PATH.join(HOME_PATH, '/.flyrc');
...
let getRcData = function () {
    ...
    try {
        let text = FS.readFileSync(FLY_RC_LOCAL_DATA_PATH, {encoding: 'utf8', flag: 'r'});
...
let upgradeRC = (data = {}) => {
    ...
    FS.writeFileSync(FLY_RC_LOCAL_DATA_PATH, JSON.stringify(newUserData), {encoding: 'utf8', flag: 'w'});

    LOG('User information configure completed!', 'green');
    LOG(`\n ${JSON.stringify(newUserData)} \n`, 'white');
};

exports.flyrc = FLY_RC_LOCAL_DATA_PATH;
